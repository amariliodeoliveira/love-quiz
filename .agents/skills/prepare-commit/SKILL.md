...
7. A request to implement, finish, or deliver authorizes focused commits and a direct push to `main` under `.agents/references/git-guidelines.md`. A request only to draft or plan does not mutate Git.
