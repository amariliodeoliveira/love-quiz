...
1. Read `.claude/git-guidelines.md`, including `Pull request descriptions`, and use a PR for its listed high-risk or isolation-worthy changes. Inspect `.github/pull_request_template.md` when it exists.
