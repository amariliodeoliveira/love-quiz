...
4. Draft the title and body in English. Use `<type>: imperative description` for the title and follow the repository PR template.
5. Explain purpose and user-visible effect, summarize focused changes, list meaningful verification, and call out risks, migrations, screenshots, or follow-ups when applicable. Omit irrelevant template sections rather than inventing content.
